...
public static class PersonalTransactionValidationMessages
{
    ...
    public const string CategoryIsRequired = "Category id is required";
    ...
    public const string CategoryIsNotFromTransaction = "The category is not from the transaction";
